...
public class SystemUserManagement extends javax.swing.JFrame {
    ...
    public SystemUserManagement() {
        ...
        new Load().loadTeacher(jComboBox2);
        loadUserType();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(acheckbox, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(icheckbox, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(554, 554, 554)))
                        .addGap(212, 212, 212))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        try {
            ...
            while (rs.next()) {
               Vector v = new Vector();
                ...
                String sql1 = "SELECT * FROM user_type WHERE user_type.id = '" + rs.getString("system_user.user_type_id") + "'";
                ResultSet userRs = MySQL.search(sql1);
                if (userRs.next()) {
                    v.add(userRs.getString("user_type.name"));
                }
                ...
                if (rs.next()) {
                    if (ps.equals(reps)) {
                        String sql = "UPDATE system_user SET username = '" + uname + "' ,"
                                + " teacher_nic ='" + sname + "', password = '" + ps + "',"
                                + " user_type_id = '" + utype + "' , status_id = '" + activeStatus + "'"
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (rs.next()) {
                ...
                String utype = rs.getString("user_type_id");
                String userSql = "SELECT * FROM user_type WHERE id = '" + utype + "'";
                ResultSet userRs = MySQL.search(userSql);
                if (userRs.next()) {
        ...
        try {
            ...
            if (!uname.equals("") && !ps.equals("") && !reps.equals("")) {
                ...
                if (sname.equals("Select")) {
                    JOptionPane.showMessageDialog(this, "Please select Staff Member!", "warning", JOptionPane.WARNING_MESSAGE);
                    ...
                    if (!rs.next()) {
                        if (ps.equals(reps)) {
                            String sql = "INSERT INTO system_user VALUES ('" + uname + "','" + sname + "',"
                                    + "'" + ps + "','" + activeStatus + "','" + utype + "')";
                            MySQL.iud(sql);
                            JOptionPane.showMessageDialog(this, "Success", "success", JOptionPane.INFORMATION_MESSAGE);

                            clearField();
                        } else {
                            JOptionPane.showMessageDialog(this, "Password Not Maching!");
                        }
                    } else {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            String userSql = "SELECT * FROM user_type WHERE name = '" + utype + "'";
            ResultSet userRs = MySQL.search(userSql);
            if (userRs.next()) {
                String user = userRs.getString("id") + "_" + userRs.getString("name");
                jComboBox1.setSelectedItem(user);
            ...
            String stuffsql = "SELECT * FROM teacher WHERE nic = '" + sname + "'";
            ResultSet stuffRs = MySQL.search(stuffsql);
            if (stuffRs.next()) {
                String stuffName = stuffRs.getString("nic") + "_" + stuffRs.getString("fname") + " " + stuffRs.getString("lname");
