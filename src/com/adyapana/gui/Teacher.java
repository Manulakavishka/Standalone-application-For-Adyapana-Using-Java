...
//        AutoCompleteDecorator.decorate(combo_bgroup);
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(rdo_f))
                                    .addComponent(txt_lname, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txt_Nic, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_fname, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIC", "Fname", "Lname", "Email", "Mobile", "DOB", "Gender", "Line 1", "Line 2", "City", "District", "Zipcode", "Status"
            }
        ) {
                ...
                .addGroup(jPanel8Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel8Layout.createSequentialGroup()
                            ...
                            .addGap(8, 8, 8)
                            .addComponent(txt_search_by_nic, javax.swing.GroupLayout.PREFERRED_SIZE, 284, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (nic.equals("")) {
                JOptionPane.showMessageDialog(this, "Please fill NIC", "warning", JOptionPane.WARNING_MESSAGE);
                ...
                String searchSql = "SELECT * FROM adyapana.teacher WHERE teacher.nic = '" + nic + "';";
                ...
                if (!rs.next()) {
                    ...
                    String sql = "INSERT INTO teacher (teacher.nic,teacher.fname,teacher.lname,teacher.email,teacher.contact_no,"
                            + "teacher.dob,teacher.status_id,teacher.gender_id,teacher.address_id,teacher.user_type_id) "
                            + "VALUES ('" + nic + "','" + fname + "','" + lname + "','" + email + "','" + mobile + "','" + dob + "','" + status + "','" + gender + "','" + addressId + "','2')";
                    MySQL.iud(sql);
                    clearField();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            String nic = txt_search_by_nic.getText();
            String sql = "SELECT * FROM adyapana.teacher WHERE teacher.nic = '" + nic + "';";
            ResultSet rs = MySQL.search(sql);
            if (!nic.equals("")) {
                if (rs.next()) {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            ...
            if (nic.equals("")) {
                ...
                String searchSql = "SELECT * FROM teacher WHERE teacher.nic = '" + nic + "'";
                ResultSet rs = MySQL.search(searchSql);
                if (rs.next()) {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try {
            ...
            if (!nic.equals("")) {
                if (rs.next()) {
                    String sql = "UPDATE teacher SET status_id = '2' WHERE nic = '" + nic + "'";
                    MySQL.iud(sql);
                    JOptionPane.showMessageDialog(this, "Success", "success", JOptionPane.INFORMATION_MESSAGE);
                } else {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String line1 = dtm.getValueAt(selectRow, 7).toString();
        String line2 = dtm.getValueAt(selectRow, 8).toString();
        String city = dtm.getValueAt(selectRow, 9).toString();
        String district = dtm.getValueAt(selectRow, 10).toString();
        String zipcode = dtm.getValueAt(selectRow, 11).toString();
        String stat = dtm.getValueAt(selectRow, 12).toString();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        CityRegistration cr = new CityRegistration(this, true, 2);
        cr.setVisible(true);
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        DistrictRegistration d = new DistrictRegistration(this, true, 2);
        d.setVisible(true);
    ...
    private void loadNIC() {
        try {
            ResultSet rs = MySQL.search("SELECT nic FROM adyapana.teacher");
            rs.next();
            txt_Nic.setText(rs.getString("nic"));
